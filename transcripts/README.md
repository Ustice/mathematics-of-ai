...
A cleanup pass should preserve mathematical explanations, corrections, user questions that changed the lesson, symbol-table decisions, and links to lesson-organized exercise images. It should remove irrelevant setup chatter, private-ish source context, and any non-course setup notes before publishing a polished lesson.
