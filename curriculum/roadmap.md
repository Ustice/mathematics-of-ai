...
The roadmap is a topic map, not a completion ledger. Use [progress-tracker.md](progress-tracker.md) for milestone evidence, [../course-state.yaml](../course-state.yaml) for the Course Checkpoint, and [../data/lesson-artifacts.json](../data/lesson-artifacts.json) for artifact relationships.
