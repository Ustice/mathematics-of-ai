...
- [ ] M4: Implement multi-head attention.
- [ ] M5: Read and reproduce results from a classic transformer paper.
- [ ] M6: Read a recent ML paper and evaluate it independently.
...
- [x] Chain rule for computation graphs introduced; Lesson 37 exercises pending.
- [x] Hessians.
- [x] Convexity.
...
### Functional Analysis and Kernels
...
- [ ] Read a classic paper and identify its mathematical assumptions.
- [ ] Reproduce a core mathematical argument from a paper.
- [ ] Implement a selected idea from a paper.
- [ ] Critique a recent paper independently.
...
- [ ] Lesson 37: Chain Rule for Computation Graphs - Lesson Page available.
