...
- [Common patterns](common-patterns.md) — Repeated mathematical patterns.
- [Concept graph](concept-graph.md) — Concept dependency map.
...
Keep symbol meanings external and easy to find. If a lesson introduces formulas, include a local notation table in the lesson and add reusable symbols here when they recur across lessons.
